            ...
            $subjectResults = FinalResult::with('subject:id,name,theory_marks,practical_marks')
                ...
                ->map(function ($sr) {
                    return [
                        ...
                        'theory_full_marks' => (float)($sr->subject->theory_marks ?? 0),
                        'practical_full_marks' => (float)($sr->subject->practical_marks ?? 0),
                        'theory_pass_marks' => (float)($sr->subject->theory_pass_marks ?? 0),
                        'practical_pass_marks' => $calculationService->getPracticalPassMarksFromActivities($sr->subject_id, $classId) ?: (float)($sr->subject->practical_pass_marks ?? 0),
        ...
        $subjectResults = FinalResult::with('subject:id,name,theory_marks,practical_marks,theory_pass_marks,practical_pass_marks')
            ...
            ->map(function ($sr) {
                return [
                    ...
                    'theory_pass_marks' => (float)($sr->subject->theory_pass_marks ?? 0),
                    'practical_pass_marks' => $calculationService->getPracticalPassMarksFromActivities($sr->subject_id, $finalResult->class_id) ?: (float)($sr->subject->practical_pass_marks ?? 0),
                    'final_theory_marks' => $sr->final_theory_marks,
                    'final_practical_marks' => $sr->final_practical_marks,
                    'final_gpa' => $sr->final_gpa,
                    'final_percentage' => $sr->final_percentage,
